      ...
      <div className="max-w-[1770px] mx-auto px-[60px] max-sm:px-[28px]">
        ...
        <div className="max-w-[948px] w-full">
          <div className="mt-[60px]">
            <form
              className="flex flex-wrap justify-between gap-y-[42px]"
            ...
            >
              <div className="w-[calc(50%-16px)] max-sm:w-[calc(50%-10px)]">
                ...
                >
                  ...
                  <option value="9">
                    [그림책] 저자 섭외, 원고 공모, 도서 문의
                  </option>
                  <option value="10">
                    [청소년] 저자 섭외, 원고 공모, 도서 문의
                  </option>
                  <option value="11">
              ...
              <p className="w-full text-[14px] leading-[28px]">
                ...
                <br />
                개인정보는 문의 접수, 고객 불편 사항 확인 및 처리 결과 회신에
                이용되며 전자상거래법 등 관련 법령에 따라 1년간 보관됩니다.
                <br />
                이용자는 본 동의를 거부할 수 있으나, 미동의 시 문의 접수가
                불가능합니다.
              </p>
