...
export default function NewBook() {
  ...
  return (
    <div className="py-[180px] relative flex items-start justify-between max-md:py-[100px] max-md:relative max-md:block after:content-[''] after:absolute after:left-[-118px] after:right-[-118px] after:bottom-0 after:border-b after:border-[#e6e6e6] max-sm:py-[70px]">
      ...
      <ul className="w-[964px] grid grid-cols-3 items-baseline overflow-hidden justify-between gap-y-[70px] gap-x-[20px] max-md:mt-[36px] max-md:w-full max-md:gap-y-[50px] max-sm:grid-cols-2 max-sm:mt-[12px]">
